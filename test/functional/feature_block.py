...
class FullBlockTest(PivxTestFramework):
    ...
    def run_test(self):
        ...
        self.send_blocks([b9], False, "bad-cb-amount", reconnect=False)
        ...
        # !TODO: fix expect_disconnect
        self.send_blocks([b11], False, "bad-cb-amount", reconnect=False)
        ...
        # !TODO: fix expect_disconnect
        self.send_blocks([b12, b13, b14], False, "bad-cb-amount", reconnect=False)
        ...
        # !TODO: fix expect_disconnect
        self.send_blocks([b68], False, "bad-cb-amount", reconnect=False)
