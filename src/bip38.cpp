...
std::string BIP38_Encrypt(std::string strAddress, std::string strPassphrase, uint256 privKey, bool fCompressed)
{
    ...
    arith_uint256 derivedHalf1 = UintToArith256(uint256S(hashed.ToString().substr(64, 64)));
    arith_uint256 derivedHalf2 = UintToArith256(uint256S(hashed.ToString().substr(0, 64)));
    ...
    arith_uint512 encryptedKey = UintToArith512(uint512S(ReverseEndianString(strPrefix + strAddressHash)));
    ...
    arith_uint512 b58Checksum = UintToArith512(uint512S(hashChecksum.ToString().substr(64 - 8, 8)));
...
bool BIP38_Decrypt(std::string strPassphrase, std::string strEncryptedKey, uint256& privKey, bool& fCompressed)
{
    ...
    arith_uint256 type = UintToArith256(uint256S(ReverseEndianString(strKey.substr(2, 2))));
    arith_uint256 flag = UintToArith256(uint256S(ReverseEndianString(strKey.substr(4, 2))));
    ...
    fCompressed = (flag & arith_uint256(0x20)) != ARITH_UINT256_ZERO;
