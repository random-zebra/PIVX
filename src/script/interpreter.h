...
public:
    ...
    virtual bool CheckColdStake(const CScript& script, bool fAllowLastOutputFree) const
    {
         return false;
    }
...
public:
    ...
    bool CheckColdStake(const CScript& prevoutScript, bool fAllowLastOutputFree) const override;
};
