...
int64_t GetSporkValue(int nSporkID)
{
    ...
    if (mapSporksActive.count(nSporkID)) {
        ...
        if (nSporkID == SPORK_17_COLDSTAKING_ENFORCEMENT) r = SPORK_17_COLDSTAKING_ENFORCEMENT_DEFAULT;
...
std::string CSporkManager::GetSporkNameByID(int id)
{
    ...
    if (id == SPORK_17_COLDSTAKING_ENFORCEMENT) return "SPORK_17_COLDSTAKING_ENFORCEMENT";
